...
from rljuly2023_features import *
...
def train(config=None):
    ...
    if True:
        ...
        for split_id, (train_index, test_index) in enumerate(kfolds):
            ...
            model = NLP2023MetaNetwork(raw_size=200, feat_size=60, hidden_size=30, nlayers_1=config.nlayers_1)
        ...
        torch.save(final_save_dict, "july2023_wtanalysis_model.pth")
