...
meta_schema= {"$schema": "http://json-schema.org/draft-07/schema#",
              ...
              "technique": "SRI value , action gradient based pipeline",
              "technique_description": "We are looking at action/value gradient, values and the final rewards",
              "technique_changes": "Some bug fixes on inferencing and loss calculation. Small changes to classifier design.",
